...
resource "aws_ecs_task_definition" "revmonkapp-task-definition" {
...
resource "aws_security_group" "app_security_group" {
  ...
  description = "Security group for revmonkapp to communicate in and out"
...
resource "aws_cloudwatch_log_group" "revmonkapp_log_group" {
